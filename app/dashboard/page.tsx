        ...
        <TabsContent value="tenders" className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" asChild className="rounded-lg">
              <Link href="/tender">View All</Link> {/* Changed from /tenders */}
            </Button>
          </div>
              ...
              <Card className="rounded-lg shadow-sm">
                <CardContent className="flex flex-col items-center justify-center py-12">
                  ...
                  <Button asChild className="rounded-lg">
                    <Link href="/tender/create">Post Your First Tender</Link> {/* Changed from /tenders/create */}
                  </Button>
                </CardContent>
              </Card>
            ) : (
                  ...
                  <CardContent>
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      ...
                      <Button variant="outline" size="sm" asChild className="rounded-lg">
                        <Link href={`/tender/${tender.id}`}> {/* Changed from /tenders/${tender.id} */}
                          <span>
            ...
            {applications.length === 0 ? (
              <Card className="rounded-lg shadow-sm">
                <CardContent className="flex flex-col items-center justify-center py-12">
                  ...
                  <Button asChild className="rounded-lg">
                    <Link href="/tender">Browse Tenders</Link> {/* Changed from /tenders */}
                  </Button>
                </CardContent>
              </Card>
            ) : (
