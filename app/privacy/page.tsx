    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <Card className="max-w-3xl w-full space-y-8 rounded-lg shadow-lg p-8">
        ...
        <CardContent className="text-gray-700 space-y-6 text-base leading-relaxed">
          <p>
            Your privacy is important to us. It is TenderHub's policy to respect your privacy regarding any information we may collect from you across our website, <Link href="/" className="text-blue-600 hover:underline">[Your Website URL]</Link>, and other sites we own and operate.
          </p>
